  ...
  return (
    ...
    >
      ...
      >
        ...
        <path className="circuit-line" d="M100 1080 C 300 900, 500 700, 700 500 C 900 300, 1100 100, 1300 50" strokeDasharray="1200" strokeDashoffset="1200" style={{animationDelay: '-1s'}}/>
        <path className="circuit-line" d="M1820 1080 C 1620 900, 1420 700, 1220 500 C 1020 300, 820 100, 620 50" strokeDasharray="1200" strokeDashoffset="1200" style={{animationDelay: '-11s'}}/>
        
        <path className="circuit-line" d="M0 540 C 480 640, 960 440, 1440 240 C 1720 140, 1920 50" strokeDasharray="1200" strokeDashoffset="1200" style={{animationDelay: '-6s'}}/>
        <path className="circuit-line" d="M1920 540 C 1440 440, 960 640, 480 840 C 240 940, 0 1030" strokeDasharray="1200" strokeDashoffset="1200" style={{animationDelay: '-16s'}}/>

        <path className="circuit-line" d="M50 50 C 500 200, 300 800, 960 1030" strokeDasharray="1200" strokeDashoffset="1200" style={{animationDelay: '-3.5s'}}/>
        <path className="circuit-line" d="M1870 50 C 1420 200, 1620 800, 960 1030" strokeDasharray="1200" strokeDashoffset="1200" style={{animationDelay: '-13.5s'}}/>

        {/* Additional paths for more complexity */}
        <path className="circuit-line" d="M10 10 C 200 300, 400 100, 600 540 C 800 980, 1000 800, 1200 1050" strokeDasharray="1500" strokeDashoffset="1500" style={{animationDelay: '-2s'}} />
        <path className="circuit-line" d="M1910 10 C 1720 300, 1520 100, 1320 540 C 1120 980, 920 800, 720 1050" strokeDasharray="1500" strokeDashoffset="1500" style={{animationDelay: '-12s'}} />
        <path className="circuit-line" d="M960 0 C 860 200, 1060 200, 960 400 C 860 600, 1060 600, 960 800 C 860 1000, 1060 1000, 960 1080" strokeDasharray="1080" strokeDashoffset="1080" style={{animationDelay: '-7.5s'}} />
        <path className="circuit-line" d="M0 100 C 640 150, 1280 50, 1920 100" strokeDasharray="1920" strokeDashoffset="1920" style={{animationDelay: '-4.5s'}} />
        <path className="circuit-line" d="M0 980 C 640 930, 1280 1030, 1920 980" strokeDasharray="1920" strokeDashoffset="1920" style={{animationDelay: '-14.5s'}} />
